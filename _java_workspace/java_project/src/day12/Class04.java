...
public class Class04 {
	/* static
	 * static이 붙은 메서드/멤버변수 클래스 멤버변수/ 메서드라고한다.
	 ...
	 * 
	 * static이 안 붙은 메서드/멤버변수는 객체(인스터스)의 멤버변수/메서드라고 한다
	...
	public static void main(String[] args) {
		...
		Tv t = new Tv(); //객체 생성 시점에 객체멥버들이 생성
		t.printPower(); //객체 메서드 사용 객체명.메서드명();
		//t.printBRAND(); //객체를 통해 클래서 멤버에 접근할 수 있지만, 그렇게 사용하지 않음
	}
...
//		door = 4;
	...
	public static void printBRAND() {
		...
		//클래스 메서드에서 객체 변수를 사용
		//System.out.println("파워상태:"+power); //불가능
	}
}
